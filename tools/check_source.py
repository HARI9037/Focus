...
for forbidden in ['android.permission.INTERNET','android.permission.QUERY_ALL_PACKAGES','android.permission.CALL_PHONE','android.permission.SYSTEM_ALERT_WINDOW']:
